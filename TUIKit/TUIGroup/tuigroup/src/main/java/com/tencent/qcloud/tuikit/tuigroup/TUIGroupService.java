...
import com.tencent.qcloud.tuikit.tuichat.Encrypt.GroupRSAPublicKey;
        ...
        V2TIMManager.getInstance().addGroupListener(new V2TIMGroupListener() {
            ...
            public void onMemberEnter(String groupID, List<V2TIMGroupMemberInfo> memberList) {
                ...
                for (V2TIMGroupMemberInfo memberInfo : memberList) {
                    ...
                    GroupRSAPublicKey groupRSAPublicKey = rsaKeyManager.getGroupRSAPublicKey(groupID);
                    groupRSAPublicKey.addMember(memberInfo.getUserID());
            ...
            public void onMemberLeave(String groupID, V2TIMGroupMemberInfo member) {
                ...
                RSAKeyManager rsaKeyManager = RSAKeyManager.getInstance();
                GroupRSAPublicKey groupRSAPublicKey = rsaKeyManager.getGroupRSAPublicKey(groupID);
                groupRSAPublicKey.removeMember(member.getUserID());
            }
            ...
            public void onMemberKicked(String groupID, V2TIMGroupMemberInfo opUser, List<V2TIMGroupMemberInfo> memberList) {
                ...
                for (V2TIMGroupMemberInfo memberInfo : memberList) {
                    ...
                    RSAKeyManager rsaKeyManager = RSAKeyManager.getInstance();
                    GroupRSAPublicKey groupRSAPublicKey = rsaKeyManager.getGroupRSAPublicKey(groupID);
                    groupRSAPublicKey.removeMember(memberInfo.getUserID());
                }
                param.put(TUIConstants.TUIGroup.GROUP_MEMBER_ID_LIST, userIds);
            ...
            public void onGroupCreated(String groupID) {
                ...
                // 群公钥类添加群
                RSAKeyManager rsaKeyManager = RSAKeyManager.getInstance();
                rsaKeyManager.addGroupRSAPublicKey(groupID);
            }
            ...
            public void onGroupDismissed(String groupID, V2TIMGroupMemberInfo opUser) {
                ...
                // 群公钥类移除群
                RSAKeyManager rsaKeyManager = RSAKeyManager.getInstance();
                rsaKeyManager.removeGroupRSAPublicKey(groupID);
