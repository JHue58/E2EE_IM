...
public class MessageShareSelectFragment extends BaseFragment {
            ...
            public void onItemClick(View view, int viewType, ConversationInfo conversationInfo) {
                if (viewType == ConversationInfo.TYPE_RECENT_LABEL){
                    ...
                    if(mTitleBarLayout.getLeftTitle().getText().equals(getString(R.string.titlebar_cancle))){
                        ...
                        TUICore.startActivity(MessageShareSelectFragment.this, "ForwardSelectGroupActivity", param, TUIConversationConstants.FORWARD_SELECT_MEMBERS_CODE);
                        ...
                        TUICore.startActivity(MessageShareSelectFragment.this, "ForwardSelectGroupActivity", param, TUIConversationConstants.FORWARD_CREATE_GROUP_CODE);
                    }else{
    ...
    private void forwardMessages(final ConversationInfo conversationInfo){
        ...
        TUIMessageBean tuiMessageBean = (TUIMessageBean) intent.getSerializableExtra("Message");
        ...
        builder.setPositiveButton(getString(R.string.sure), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (getActivity() != null) {
                    ...
                    info.setGroupType(conversationInfo.getGroupType());
                    if (conversationInfo.isGroup()){
                        info.setType(V2TIMConversation.V2TIM_GROUP);
                    }
                    info.setId(conversationInfo.getId());
                    info.setChatName(conversationInfo.getShowName());
                    chatProvider.sendMessage(tuiMessageBean, info, new IUIKitCallback<TUIMessageBean>() {
                        @Override
                        public void onSuccess(TUIMessageBean data) {
                            super.onSuccess(data);
                            ToastUtil.toastLongMessage("转发成功");
                        }
