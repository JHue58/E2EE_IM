        ...
        if (!isOriginImg) {
            ...
            holder.viewOriginalButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    finalMCurrentOriginalImage.downloadImage(path[0], new V2TIMDownloadCallback() {
                        @Override
                        ...
                        public void onSuccess() {
                            BackgroundTasks.getInstance().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    EncryptUtil.imageDeEncrypt(path[0]);
                                    holder.photoView.setImageBitmap(ImageUtil.adaptBitmapFormPath(path[0], DeviceUtil.getScreenSize()[0], DeviceUtil.getScreenSize()[1]));
                                    ...
                                    intent.putExtra(DOWNLOAD_ORIGIN_IMAGE_PATH, path[0]);
